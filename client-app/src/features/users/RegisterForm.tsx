    ...
    return (
        ...
        >
            {({handleSubmit, isSubmitting, errors, isValid, dirty}) => (
                <Form className='ui form error' onSubmit={handleSubmit} autoComplete='off' style={{margin: '3em 2em'}}>
                     <img className='ui small centered image' src='/assets/logo.png' alt='logo' style={{marginBottom:"5em" }} />
                    <Header as='h2' content='Join our community!' color='teal' textAlign='center'/>
